...
router.get('/index', function (req, res) {
  ...
  res.render('index', {
    layout: 'index',
    page: {
      title: 'Resume-Pet_My-Not-My_Project',
    },
    header,
    first: {
      prof: 'Abuot Professional',
      summary: '/summary',
      skills: '/skills',
      education: '/education',
      work: '/work',
...
router.get('/list', function (req, res) {
  ...
  res.render('list', {
    ...
    // 5-3шт коду
    usersss: {
      name: { value: 'ivansss', txt: 'Ivanovsss' },
      role: { value: 'adminsss' },
      isconfeg: { txt: true },
      age: { value: 32 },
    },
      ...
      itemList: [
        {
          ...
          images: ['https://picsum.photos/60/55'],
          button: {
            text: 'Детальніше',
            link: 'https://www.youtube.com/',
            isPrimary: true,
